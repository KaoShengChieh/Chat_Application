...
public class FriendsJPanel extends JPanel {
	...
	public FriendsJPanel() {
		...
		label_1.setIcon(new ImageIcon(FriendsJPanel.class.getResource("image/user.png")));
		...
		label_2.setIcon(new ImageIcon(FriendsJPanel.class.getResource("image/user.png")));
		...
		label_3.setIcon(new ImageIcon(FriendsJPanel.class.getResource("image/user.png")));
		...
		label_5.setIcon(new ImageIcon(FriendsJPanel.class.getResource("image/user.png")));
		...
		label_7.setIcon(new ImageIcon(FriendsJPanel.class.getResource("image/user.png")));
		...
		label.setIcon(new ImageIcon(FriendsJPanel.class.getResource("image/user.png")));
